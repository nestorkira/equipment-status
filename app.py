...
CONFIG_EQUIPOS = {
    ...
    "TD080": {"orden": 8,  "grupo": "DTH"},
    "TD081": {"orden": 9,  "grupo": "DTH"},
    "TD082": {"orden": 10,  "grupo": "DTH"},
    "TD083": {"orden": 11,  "grupo": "DTH"},

    "TD091": {"orden":12,  "grupo": "RTR"},
    "TD092": {"orden":13,  "grupo": "RTR"},

    "TD073": {"orden":14,  "grupo": "FUERA"},
    "TD030": {"orden":15,  "grupo": "FUERA"},
    "TD076": {"orden":16,  "grupo": "FUERA"},
